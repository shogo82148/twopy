...
def __detectStatusCode(body):
  ...
  """
  if __status_false.search(body): return STATUS_FALSE
  elif __status_true.search(body): return STATUS_TRUE
  elif __status_error.search(body): return STATUS_ERROR
  elif __status_check.search(body): return STATUS_CHECK
  elif __status_cookie.search(body): return STATUS_COOKIE
  else: raise TypeError, "twopy can't detect the status code." 
